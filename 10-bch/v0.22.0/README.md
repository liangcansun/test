...
## mainnet
# tag
docker tag bch:0.22.0 registry.cn-beijing.aliyuncs.com/poolin/bch:0.22.0
docker tag bch:0.22.0 registry.cn-hongkong.aliyuncs.com/poolin/bch:0.22.0
docker tag bch:0.22.0 registry.us-east-1.aliyuncs.com/poolin/bch:0.22.0

# push
docker push registry.cn-beijing.aliyuncs.com/poolin/bch:0.22.0
docker push registry.cn-hongkong.aliyuncs.com/poolin/bch:0.22.0
docker push registry.us-east-1.aliyuncs.com/poolin/bch:0.22.0
```
...
docker run --env-file /work/config/docker_env_bch \
--dns 8.8.8.8 \
--dns 119.29.29.19 \
--dns 182.254.116.116 \
--dns 114.114.114.114 \
...
-d registry.cn-beijing.aliyuncs.com/poolin/bch:0.22.0

# start testnet docker
docker run --env-file /work/config/docker_env_bch_testnet \
--dns 8.8.8.8 \
--dns 119.29.29.19 \
--dns 182.254.116.116 \
--dns 114.114.114.114 \
