...
```shell
# build 
docker build -t bitcoin-cash-node:0.21.0 .
```
...
## mainnet
# tag
docker tag bitcoin-cash-node:0.21.0 registry.cn-beijing.aliyuncs.com/poolin/bitcoin-cash-node:0.21.0
docker tag bitcoin-cash-node:0.21.0 registry.cn-hongkong.aliyuncs.com/poolin/bitcoin-cash-node:0.21.0
docker tag bitcoin-cash-node:0.21.0 registry.us-east-1.aliyuncs.com/poolin/bitcoin-cash-node:0.21.0

# push
docker push registry.cn-beijing.aliyuncs.com/poolin/bitcoin-cash-node:0.21.0
docker push registry.cn-hongkong.aliyuncs.com/poolin/bitcoin-cash-node:0.21.0
docker push registry.us-east-1.aliyuncs.com/poolin/bitcoin-cash-node:0.21.0
```
...
-d registry.cn-beijing.aliyuncs.com/poolin/bitcoin-cash-node:0.21.0
